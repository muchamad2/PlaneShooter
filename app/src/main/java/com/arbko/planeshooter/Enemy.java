package com.arbko.planeshooter;
...
import static com.arbko.planeshooter.GameView.SCORE;
public class Enemy {
    ...
    public Enemy(Context context, int screenSizeX, int screenSizeY, SoundPlayer soundPlayer) {
        ...
        mEnemies = new int[]{R.drawable.enemy1, R.drawable.enemy2, R.drawable.enemy3};
